...
logo = pygame.image.load(r"E:\All Files of Python3\Arduino_Scope\Software\images\PyLogo.png").convert_alpha()
...
def drawControls():
    ...
    drawWords("1/"+chr(0xff)+"Time",540,257,black,backCol)
    drawWords(chr(0xff)+"Time",540,237,black,backCol)
    drawWords("Saved Time",540,217,black,backCol)
    drawWords("Time",540,197,black,backCol)
    drawWords(chr(0xff)+"Voltage",540,167,black,backCol)
